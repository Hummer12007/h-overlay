...
MOZ_HTTP_URI="https://ftp.mozilla.org/pub/firefox-aurora/nightly/latest-mozilla-aurora"

FEATURES="-strict assume-digests nostrip force-mirror"
...
SRC_URI="${SRC_URI}
	...
	x86? ( ${MOZ_HTTP_URI%/}/${MOZ_P}.en-US.linux-i686.tar.bz2 -> ${PN}_i686-${PV}.tar.bz2 )"
...
src_install() {
	...
	#!/bin/sh
	unset LD_PRELOAD
	LD_LIBRARY_PATH="/opt/firefox-aurora/"
